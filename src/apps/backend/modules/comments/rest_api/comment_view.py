...
from modules.comments.errors import CommentBadRequestError
...
class CommentView(MethodView):
    ...
    def post(self, account_id: str, task_id: str) -> ResponseReturnValue:
        ...
        create_params = CreateCommentParams(account_id=account_id, task_id=task_id, content=request_data["content"])
