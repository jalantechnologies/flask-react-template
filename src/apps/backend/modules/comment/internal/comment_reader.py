...
from modules.comment.types import Comment, GetCommentParams, GetPaginatedCommentParams
...
class CommentReader:
    ...
    @staticmethod
    def get_paginated_comments(*, params: GetPaginatedCommentParams) -> PaginationResult[Comment]:
        filter_query = {"account_id": params.account_id, "task_id": params.task_id}
