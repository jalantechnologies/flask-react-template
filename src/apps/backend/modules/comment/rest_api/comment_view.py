...
class CommentView(MethodView):
    ...
    def get(self, account_id: str, task_id: str, comment_id: Optional[str] = None) -> ResponseReturnValue:
        if comment_id:
            comment_params = GetCommentParams(task_id=task_id, account_id=account_id, comment_id=comment_id)
            ...
            comments_params = GetPaginatedCommentsParams(task_id=task_id, account_id=account_id, pagination_params=pagination_params)
    ...
    def patch(self, account_id: str, task_id: str, comment_id: str) -> ResponseReturnValue:
        ...
        update_comment_params = UpdateCommentParams(
            task_id=task_id, account_id=account_id, comment_id=comment_id, content=request_data["content"]
        )
    ...
    def delete(self, account_id: str, task_id: str, comment_id: str) -> ResponseReturnValue:
        delete_params = DeleteCommentParams(task_id=task_id, account_id=account_id, comment_id=comment_id)
