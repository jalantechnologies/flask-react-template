...
class CommentService:
    ...
    @staticmethod
    def get_comment(*, account_id: str, comment_id: str) -> Comment:
        return CommentReader.get_comment(account_id=account_id, comment_id=comment_id)
    
    @staticmethod
    def get_paginated_comments(*, params: GetCommentsParams) -> PaginationResult[Comment]:
