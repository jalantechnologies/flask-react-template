...
def serve_react_home(path: str) -> Response:
...
react_img_assets_dir: str = os.path.join(os.getcwd(), f"{satic_root}/src/assets/img")
img_assets_blueprint = Blueprint("image_assets", __name__, static_folder=react_img_assets_dir, url_prefix="/assets")


@img_assets_blueprint.route("/img/<path:filename>", methods=["GET"])
