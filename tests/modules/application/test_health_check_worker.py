...
class TestGivenBackendIsRunning:
    class TestWhenHealthCheckReturns200:
        ...
        def test_then_logs_healthy_status(
            self, mock_logger_info: MagicMock, mock_requests_get: MagicMock
        ) -> None:
            ...
            mock_requests_get.assert_called_once_with("http://localhost:8080/api/", timeout=3)
    ...
    class TestWhenHealthCheckReturns500:
        ...
        def test_then_logs_unhealthy_status_with_code(
            self, mock_logger_error: MagicMock, mock_requests_get: MagicMock
        ) -> None:
            mock_response = MagicMock()
