...
class BaseTestComment(unittest.TestCase):
    ...
    def create_test_account(self, username: str = None, password: str = None, first_name: str = None, last_name: str = None) -> Account:
    ...
    def make_cross_account_request(
        self, method: str, target_account_id: str, target_task_id: str, auth_token: str, comment_id: str = None, data: dict = None
    ):
        if comment_id:
            url = self.get_comment_by_id_api_url(target_account_id, target_task_id, comment_id)
        else:
            url = self.get_comment_api_url(target_account_id, target_task_id)
